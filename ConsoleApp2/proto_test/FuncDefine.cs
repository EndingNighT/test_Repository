    ...
    public static void CopyMessage(IMessage message)
    {
        ...
        foreach (var field in descriptor.Fields.InDeclarationOrder())
        {
            try
            {
                ...
                {
                    var value_ = field.Accessor.GetValue(message);
                    var type_ = field.Accessor.GetValue(message).GetType();
...
public static class StructToProtobufMapper
{
    ...
    public static IEnumerable<T>? ConvertToEnumerable<T>(object obj)
    {
